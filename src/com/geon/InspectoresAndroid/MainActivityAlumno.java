...
import com.geon.alumno.Ver_Alumno;
import com.geon.alumno.Ver_Anotacion_Libro;
import com.geon.alumno.Ver_Anotaciones_Internas;
import com.geon.alumno.Ver_Atraso;
import com.geon.alumno.search_alumno;
import com.geon.login.home;
...
public class MainActivityAlumno extends FragmentActivity implements
ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_activity_alumno);
		...
		ActionBar.Tab AlInicio = actionbar.newTab().setText(
				getString(R.string.al_inicio));
		ActionBar.Tab AlAnotaaciones = actionbar.newTab().setText(
				getString(R.string.al_anotacion));
		ActionBar.Tab AlAtrasos = actionbar.newTab().setText(
				getString(R.string.al_atrasos));
	...
	public void onTabSelected(Tab tab, android.app.FragmentTransaction ft) {
		...
		Fragment fragment =  new Ver_Alumno();
		Bundle arguments = new Bundle();
		switch (tab.getPosition()) {
		case 0:
			fragment = new Ver_Alumno();
			getSupportFragmentManager().beginTransaction()
	        .replace(R.id.fragment_container, fragment).commit();
			break;
		case 1:
			fragment = new Ver_Anotacion_Libro();
			 
		       
		        arguments.putBoolean("shouldYouCreateAChildFragment", false);
		    
		        fragment.setArguments(arguments);
		        getSupportFragmentManager().beginTransaction().replace(R.id.content_alumno, fragment).commit();
			
			break;
		case 2:
			fragment = new Ver_Atraso();
